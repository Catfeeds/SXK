package com.example.cfwifine.sxk.Section.MineNC.Controller.MineIDIdentify;
...
public class IDIdentifyAC extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText id_name_edittext;
    private RelativeLayout publish_name;
    private EditText id_idnumber_edittext;
    private RelativeLayout publish_color;
    ...
    Dialog dialog;
    private ArrayList<Bitmap> dataList = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ididentify_ac);
    ...
    private void initView() {
        ...
        navi_title.setText("提交身份信息");
        navi_right = (TextView) findViewById(R.id.navi_right);
        navi_right.setText("");
        navi_right_lays = (LinearLayout) findViewById(R.id.navi_right_lays);
        id_name_edittext = (EditText) findViewById(R.id.id_name_edittext);
        publish_name = (RelativeLayout) findViewById(R.id.publish_name);
        id_idnumber_edittext = (EditText) findViewById(R.id.id_idnumber_edittext);
        publish_color = (RelativeLayout) findViewById(R.id.publish_color);
    ...
    private void submit() {
        ...
        idnumber = id_idnumber_edittext.getText().toString().trim();
        if (TextUtils.isEmpty(idnumber)) {
            ...
            try {
                String errInfo = cc.IDCardValidate(idnumber);
    ...
    private void initIOSSheetDialog() {
        shitView = new LikeIOSSheetDialog.Builder(IDIdentifyAC.this)
                .setTitle("更换头像")
                .addMenu("从手机相册选择", new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        shitView.dismiss();
                        // 安卓6.0权限适配
                        if (ContextCompat.checkSelfPermission(IDIdentifyAC.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                                != PackageManager.PERMISSION_GRANTED) {
                            ActivityCompat.requestPermissions(IDIdentifyAC.this,
                                    new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},
                                    REQUEST_CODE);
                        } else {//权限被授予
                            startActivityForResult(MQPhotoPickerActivity.newIntent(IDIdentifyAC.this, null, 1, mResults, "完成"), REQUEST_CODE);
                        }
                    }
...
//                        Toast.makeText(v.getContext(), "拍一张" , Toast.LENGTH_SHORT).show();
                        ...
                        if (ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                            //如果没有授权，则请求授权
                            ActivityCompat.requestPermissions(IDIdentifyAC.this, new String[]{Manifest.permission.CAMERA}, 733);
                        } else {
                            //有授权，直接开启摄像头
                            takePhoto();
                        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == REQUEST_CODE) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                // Permission Denied
                Toast.makeText(IDIdentifyAC.this, "Permission Denied", Toast.LENGTH_SHORT).show();
            }
            return;
        }
        if (requestCode == 733) {
...
//                    uploadImageToQiniuByChar(bytes,token);
    ...
    private void setPicToView(Intent picdata) {
        ...
        if (extras != null) {
            ...
            urlpath = DFileUtils.saveFile(IDIdentifyAC.this, "temphead.jpg", photo);
            if (isOne) {
