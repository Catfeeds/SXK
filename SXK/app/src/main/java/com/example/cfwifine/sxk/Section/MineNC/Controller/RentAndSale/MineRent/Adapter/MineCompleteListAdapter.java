...
public class MineCompleteListAdapter extends RecyclerView.Adapter<MineCompleteListAdapter.ViewHolder> {
    private final List<MineItemCompletedGoodsModel.OrderListBean> classifyDataSource;
    ...
    public MineCompleteListAdapter(Context mContext, List<MineItemCompletedGoodsModel.OrderListBean> classifyDataSource) {
