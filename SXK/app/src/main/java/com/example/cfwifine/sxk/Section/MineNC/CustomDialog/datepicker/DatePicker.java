package com.example.cfwifine.sxk.Section.MineNC.CustomDialog.datepicker;
...
public class DatePicker extends LinearLayout {
	...
	private void init(Context context){
		...
		for (int i = 0; i < 7; i++) {
			...
			Log.e("数组",""+dateList.get(i).getYear());
			nowYears = (dateList.get(i).getYear());
		}

//		yearList = new ArrayList<>();
//		for (int i = 0; i<50; i++){
//			nowYears-=1;
//			yearList.add(nowYears);
//			dateList.add(nowYears);
//		}
//		Log.e("",""+yearList);
		...
		newDays.setAdapter(new StringWheelAdapter(dateList, 50));
