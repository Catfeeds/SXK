...
public class RecyclerBanner extends FrameLayout {
    ...
    private void setPoint() {
        int i = currentIndex % datas.size() + 1;
        now_num.setText(i+"");
    }
    ...
    public int setDatas(List<BannerEntity> datas, TextView now_num) {
