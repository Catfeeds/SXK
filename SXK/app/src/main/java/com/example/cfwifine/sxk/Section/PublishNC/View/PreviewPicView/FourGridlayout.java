...
public class FourGridlayout extends ViewGroup {
    ...
    private FourGridAdapter adapter;
    private OnItemClickListerner onItemClickListerner;
    /**
     * 默认图片间隔
     */
    private final int ITEM_GAP = 4;
    ...
    public FourGridlayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FourGridlayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setAdapter(FourGridAdapter adapter) {
