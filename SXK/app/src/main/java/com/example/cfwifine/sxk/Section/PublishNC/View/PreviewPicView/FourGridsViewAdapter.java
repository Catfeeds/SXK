...
public class FourGridsViewAdapter extends FourGridAdapter {


    public FourGridsViewAdapter(Context context, List list) {
        super(context, list);
    }
...
//        Picasso.with(context).load(getUrl(i)).placeholder(new ColorDrawable(Color.parseColor("#f5f5f5"))).into(iv);
        ...
        if (list.get(i).equals("TAG")) {
            ...
            String picUrl = BaseInterface.ClassfiyGetAllHotBrandImgUrl + list.get(i);
