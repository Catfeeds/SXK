...
package com.example.cfwifine.sxk.Section.MineNC.CustomDialog.AddressPickerView;
...
import com.example.cfwifine.sxk.Section.MineNC.CustomDialog.AddressPickerView.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.home_bg));
		// 设置线宽
