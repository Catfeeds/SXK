...
import com.example.cfwifine.sxk.Section.MineNC.Controller.RentAndSale.MineRent.Adapter.MineBoZhuWaitListAdapter;
...
public class RebackGoodsFC extends Fragment {
    ...
    private List<MineItemBoZhuWaitReceModel.OrderListBean> DataSouce;
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        if (status == 4) {
                            ...
                            if (mineItemBoZhuWaitReceModel.getCode() == 1) {
                                if (mineItemBoZhuWaitReceModel.getTotal() == 0){
                                    no_order.setVisibility(View.VISIBLE);
                                    swiperefresh.setVisibility(View.GONE);
                                }else {
                                    DataSouce = mineItemBoZhuWaitReceModel.getOrderList();
                                    initSheHeRV();
                                }
