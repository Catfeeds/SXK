...
import com.example.cfwifine.sxk.Section.MineNC.Controller.MineRent.Adapter.MineCompleteListAdapter;
...
public class CompletedOrderFC extends Fragment {
    ...
    private List<MineItemCompletedGoodsModel.BrandListBean> DataSouce;
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        if (status == 5) {
                            ...
                            if (mineItemCompletedGoodsModel.getCode() == 1) {
                                DataSouce = mineItemCompletedGoodsModel.getBrandList();
                                initSheHeRV();
