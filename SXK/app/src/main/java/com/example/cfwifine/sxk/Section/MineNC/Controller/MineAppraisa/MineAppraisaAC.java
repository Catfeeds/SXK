...
public class MineAppraisaAC extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mine_appraisa_ac);
    ...
    private void initView() {
        ...
        MineItemAppraisaViewpageAdapter mineItemCuringViewpageAdapter = new MineItemAppraisaViewpageAdapter(fragmentManager);
    ...
    public void initSnackBar(String value) {
        SnackbarUtils.showShortSnackbar(MineAppraisaAC.this.getWindow().getDecorView(), value, Color.WHITE, Color.parseColor("#16a6ae"));
