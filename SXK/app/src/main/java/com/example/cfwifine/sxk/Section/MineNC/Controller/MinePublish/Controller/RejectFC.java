...
import com.example.cfwifine.sxk.Section.MineNC.Controller.MinePublish.Adapter.MineNoPassListAdapter;
...
public class RejectFC extends Fragment {
...
//        mAdapter = new  (getActivity(), classifySo);
        mSheHeAdapter = new MineNoPassListAdapter(getActivity(),rentListDataSouce);
        hao_recycleview.setAdapter(mSheHeAdapter);
        mSheHeAdapter.setOnItemClickListener(new MineNoPassListAdapter.OnItemClickListener() {
            @Override
