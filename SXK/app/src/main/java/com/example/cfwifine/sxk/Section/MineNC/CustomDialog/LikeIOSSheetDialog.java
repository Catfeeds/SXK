...
/**
 * Created by cfwifine on 16/12/2.
 */
...
public class LikeIOSSheetDialog extends Dialog {

    public LikeIOSSheetDialog(Context context, int themeResId) {
    ...
    public static class Builder {
        ...
        public LikeIOSSheetDialog create() {
            final LikeIOSSheetDialog dialog = new LikeIOSSheetDialog(p.context, shadow ? R.style.Theme_Light_NoTitle_Dialog : R.style.Theme_Light_NoTitle_NoShadow_Dialog);
