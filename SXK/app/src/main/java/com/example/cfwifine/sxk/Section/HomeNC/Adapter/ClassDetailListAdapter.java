...
public class ClassDetailListAdapter extends RecyclerView.Adapter<ClassDetailListAdapter.ViewHolder> {
    private Context mContext;
    private LayoutInflater mInflater;
    private List<HomeClassSelectedModel.ClassBean.RentListBean> classifyDataSource;

    private ClassDetailListAdapter.OnItemClickListener mOnItemClickListener;

    public interface  OnItemClickListener{
        void OnItemClick(View view, int maintainid);
    }
    public void setOnItemClickListener(ClassDetailListAdapter.OnItemClickListener onItemClickListener) {
        this.mOnItemClickListener = onItemClickListener;
    }

    public ClassDetailListAdapter(Context mContext, List<HomeClassSelectedModel.ClassBean.RentListBean> classifyDataSource) {
    ...
    @Override
    public ClassDetailListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(mInflater.inflate(R.layout.item_threeblock_main_list, parent, false));
    }

    @Override
    public void onBindViewHolder(final ClassDetailListAdapter.ViewHolder holder, final int position) {
