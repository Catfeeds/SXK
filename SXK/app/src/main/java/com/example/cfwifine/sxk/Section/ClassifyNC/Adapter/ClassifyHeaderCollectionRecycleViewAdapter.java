...
public class ClassifyHeaderCollectionRecycleViewAdapter extends RecyclerView.Adapter<ClassifyHeaderCollectionRecycleViewAdapter.ViewHolder> {
    public ArrayList<TestModel> datas = null;

    public ClassifyHeaderCollectionRecycleViewAdapter() {
//        ArrayList<TestModel> datas
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_header_collection, viewGroup, false);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        viewHolder.mTextView.setText("这是测试");
