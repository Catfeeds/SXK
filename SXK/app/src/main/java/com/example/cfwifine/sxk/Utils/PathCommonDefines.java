...
public class PathCommonDefines {
	...
	// "http://xianshisong.cn/service.php";
	// public final static String SERVER_IMAGE_ADDRESS =
	// "http://xianshisong.cn/service.php";
	//
	// public final static String MESSAGE_URL = "";
	// // System
	// public final static String API_POST_DEV_BASIC = "/common/devices/add";
	// public final static String API_POST_PRODUCT_ANALYSIS =
	// "/common/user_behaviors/add";
	// public final static String APP_PREF_FILE = "sssconf";
	public static final String APP_FOLDER_ON_SD = Environment
			.getExternalStorageDirectory().getAbsolutePath() + "/SHEXIANGKE";
	...
	// public final static String API_GET_PRODUCT_CATEGORY_LIST =
	// "?action=getProductCategoryList";
	// public final static String API_GET_ADVERT_PRODUCT_LIST =
	// "?action=getAdvertProductList";
	// public final static String API_PRODUCT_LIST = "?action=getProductList";
	// public final static String API_GET_PRODUCT_BY_ID =
	// "?action=getProductById";
	// public final static String API_GET_COMMENT = "?action=getcomment";
	// public final static String API_GET_ENTERPRISE_ABSTRACT =
	// "?action=getEnterpriseAbstract";
	...
	// public final static String API_SET_ACQUIESCE_ADDRESS =
	// "?action=setaddress";
	// public final static String API_GET_ADDRESS_LIST =
	// "?action=getaddresslist";
	// public final static String API_GET_REGION_ADDRESS_LIST =
	// "?action=getarea";
	...
	// public final static String API_MODIFY_PASSWORD =
