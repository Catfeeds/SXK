...
public class MineItemAppraisaDoneListAdapter extends RecyclerView.Adapter<MineItemAppraisaDoneListAdapter.ViewHolder> {
    private final List<MineItemAppraisaModel.OrderListBean> classifyDataSource;
    private Context mContext;
    private LayoutInflater mInflater;


    private MineItemAppraisaDoneListAdapter.OnItemClickListener mOnItemClickListener;

    public interface  OnItemClickListener{
        void OnItemClick(View view, int maintainid);
    }
    public void setOnItemClickListener(MineItemAppraisaDoneListAdapter.OnItemClickListener onItemClickListener) {
        this.mOnItemClickListener = onItemClickListener;
    }

    public MineItemAppraisaDoneListAdapter(Context mContext, List<MineItemAppraisaModel.OrderListBean> classifyDataSource) {
//        mInflater = LayoutInflater.from(mContext);
    ...
    @Override
    public MineItemAppraisaDoneListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_mine_publish_appraisa_list, parent, false);
        MineItemAppraisaDoneListAdapter.ViewHolder vh = new MineItemAppraisaDoneListAdapter.ViewHolder(view);
        return vh;
//        return new ViewHolder(mInflater.inflate(R.layout.item_mine_nopass_list, parent, false));
    }

    @Override
    public void onBindViewHolder(final MineItemAppraisaDoneListAdapter.ViewHolder holder, final int position) {
