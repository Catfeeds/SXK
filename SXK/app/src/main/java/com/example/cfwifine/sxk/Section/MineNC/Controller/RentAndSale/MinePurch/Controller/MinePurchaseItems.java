...
import com.example.cfwifine.sxk.Section.MineNC.Controller.RentAndSale.MinePurch.Adapter.MineItemPurchaseViewpageAdapter;
...
public class MinePurchaseItems extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mine_purchase_items);
    ...
    private void initView() {
        ...
        MineItemPurchaseViewpageAdapter mineItemSaleViewpageAdapter = new MineItemPurchaseViewpageAdapter(fragmentManager);
    ...
    public void initSnackBar(String value) {
        SnackbarUtils.showShortSnackbar(MinePurchaseItems.this.getWindow().getDecorView(), value, Color.WHITE, Color.parseColor("#16a6ae"));
