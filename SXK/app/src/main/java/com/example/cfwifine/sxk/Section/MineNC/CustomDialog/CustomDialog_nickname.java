...
public class CustomDialog_nickname extends Dialog{
    ...
    public CustomDialog_nickname(Context context) {
        super(context);
        mContext = context;
    }

    public CustomDialog_nickname(Context context, ICustomDialogEventListener listener, int theme) {
        super(context, theme);
        mContext = context;
