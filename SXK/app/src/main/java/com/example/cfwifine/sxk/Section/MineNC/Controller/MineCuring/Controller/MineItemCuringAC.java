...
public class MineItemCuringAC extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mine_item_curing_ac);
    ...
    private void initView() {
        ...
        MineItemCuringViewpageAdapter mineItemCuringViewpageAdapter = new MineItemCuringViewpageAdapter(fragmentManager);

        ViewPager viewPager = (ViewPager) findViewById(R.id.viewpagers);
        viewPager.setAdapter(mineItemCuringViewpageAdapter);
        mineItemCuringViewpageAdapter.addAll(datas);
    ...
    public void initSnackBar(String value) {
        SnackbarUtils.showShortSnackbar(MineItemCuringAC.this.getWindow().getDecorView(), value, Color.WHITE, Color.parseColor("#16a6ae"));
