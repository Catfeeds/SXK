...
public class CustomDialog_publish_success extends Dialog{
    ...
    public CustomDialog_publish_success(Context context) {
        super(context);
        mContext = context;
    }

    public CustomDialog_publish_success(Context context, int theme) {
        super(context, theme);
        mContext = context;
//        mCustomDialogEventListener = listener;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View layout = inflater.inflate(R.layout.dialog_publish_success, null);
